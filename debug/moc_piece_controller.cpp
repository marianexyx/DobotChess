...
QT_MOC_LITERAL(3, 33, 3) // "LOG"
    ...
    "PieceController\0addTextToLogPTE\0\0LOG"
};
...
void PieceController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PieceController::addTextToLogPTE)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PieceController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PieceController.data,
      qt_meta_data_PieceController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PieceController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PieceController.stringdata0))
        return static_cast<void*>(const_cast< PieceController*>(this));
