...
void ChessStatus::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChessStatus::setBoardDataLabel)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChessStatus::showLegalMoves)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ChessStatus::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChessStatus::showHistoryMoves)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject ChessStatus::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ChessStatus.data,
      qt_meta_data_ChessStatus,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ChessStatus::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChessStatus.stringdata0))
        return static_cast<void*>(const_cast< ChessStatus*>(this));
