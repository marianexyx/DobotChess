...
QT_MOC_LITERAL(1, 11, 23), // "showQueuedArmCmdsOnCore"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 22), // "showSentArmCmdsToDobot"
...
void DobotQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DobotQueue::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DobotQueue::showQueuedArmCmdsOnCore)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DobotQueue::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DobotQueue::showSentArmCmdsToDobot)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DobotQueue::showQueuedArmCmdsOnCore()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DobotQueue::showSentArmCmdsToDobot()
{
