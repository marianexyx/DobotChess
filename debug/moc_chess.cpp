...
QT_MOC_LITERAL(8, 89, 30), // "findInitialPieceNrOnGivenField"
QT_MOC_LITERAL(9, 120, 6), // "sField"
QT_MOC_LITERAL(10, 127, 28), // "findInitialFieldOfGivenPiece"
QT_MOC_LITERAL(11, 156, 6), // "sPiece"
QT_MOC_LITERAL(12, 163, 19) // "resetPiecePositions"

    },
    "Chess\0addTextToConsole\0\0checkMsgFromChenard\0"
    "tcpMsgType\0tcpRespond\0checkMsgForChenard\0"
    "msg\0findInitialPieceNrOnGivenField\0"
    "sField\0findInitialFieldOfGivenPiece\0"
    "sPiece\0resetPiecePositions"
};
...
static const uint qt_meta_data_Chess[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Short, QMetaType::Short,    9,
    QMetaType::Short, QMetaType::Short,   11,
    QMetaType::Void,
...
void Chess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { short _r = _t->findInitialPieceNrOnGivenField((*reinterpret_cast< short(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< short*>(_a[0]) = _r; }  break;
        case 4: { short _r = _t->findInitialFieldOfGivenPiece((*reinterpret_cast< short(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< short*>(_a[0]) = _r; }  break;
        case 5: _t->resetPiecePositions(); break;
        default: ;
        }
