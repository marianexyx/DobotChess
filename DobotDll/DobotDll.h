...
extern "C" int ConnectDobot(const char *portName, int baudrate);
extern "C" void DisconnectDobot(void);
extern "C" void SetCmdTimeout(uint32_t cmdTimeout);
...
extern "C" int SetCPCmdEx(CPCmd *cpCmd, bool isQueued, uint64_t *queuedCmdIndex);
